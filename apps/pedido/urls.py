...
from .views import Render_html, Listar, Cargar_pedido,Modificar_pedido,Finalizar_pedido,Borrar_pedido,verPedido
...
urlpatterns = [
    ...
    path('Finalizar/<pk>',Finalizar_pedido.as_view(),name='finalizar'),
